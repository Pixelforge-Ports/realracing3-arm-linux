 ...
 *
 * A Knulli (Batocera-derived) user got this port, Dead Space and Mass Effect
 * running by hand-exporting SDL_VIDEODRIVER="mali" before the launch line - his
 * verdict on this one was "rough around the edges but works good enough to
 * play", on a firmware where it had not started at all. That
 ...
 */
#ifndef REALRACING3_SDL_INFO_H
#define REALRACING3_SDL_INFO_H
